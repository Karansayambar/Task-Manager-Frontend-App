...
import { loginUser } from "../redux/thunk/authThunkActions";
    ...
    <div className=" h-screen w-screen container flex fixed justify-center top-20 tab:top-0  tab:items-center  ">
      <div className="border flex bg-[#EEF6EF] space-y-8 flex-col py-6  ">
        ...
        <div className="px-24 ">
          <div
            onClick={handleLogin}
            className="py-2  px-24 flex w-[300px] cursor-pointer bg-[#3F9142] rounded-md text-white 
      font-semibold justify-center items-center"
          >
            Login
          </div>
          <Link to={"/register"}>
            <p className="text-center p-2">Please Register First</p>
          </Link>
        </div>
      </div>
    </div>
